...
public record RuntimeNodeResponse(
    ...
    public static RuntimeNodeResponse from(
        ...
        Double orientationX = runtime != null && runtime.getOrientationX() != null
                ? runtime.getOrientationX()
                : telemetry == null ? null : telemetry.getOrientationX();
        Double orientationY = runtime != null && runtime.getOrientationY() != null
                ? runtime.getOrientationY()
                : telemetry == null ? null : telemetry.getOrientationY();
        Double orientationZ = runtime != null && runtime.getOrientationZ() != null
                ? runtime.getOrientationZ()
                : telemetry == null ? null : telemetry.getOrientationZ();
        Double orientationW = runtime != null && runtime.getOrientationW() != null
                ? runtime.getOrientationW()
                : telemetry == null ? null : telemetry.getOrientationW();
    ...
    public static RuntimeNodeResponse offline(
        ...
        Double orientationX = telemetry == null ? null : telemetry.getOrientationX();
        Double orientationY = telemetry == null ? null : telemetry.getOrientationY();
        Double orientationZ = telemetry == null ? null : telemetry.getOrientationZ();
        Double orientationW = telemetry == null ? null : telemetry.getOrientationW();
        GeoCoordinateService.GeoCoordinate coordinate = geoCoordinateService.fromLocal(
                positionX,
                positionY,
                positionZ
